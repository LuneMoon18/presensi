...
<body class="d-flex flex-column" style="background-color: #000000;">
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            <form class="card card-md" style="background-color: #F1F1F1;" action="{{route('actionregister')}}"
                ...
                <div class="card-body">
                    ...
                    <div class="form-footer">
                        <button type="submit" class="btn btn-primary w-100"
                            style="background-color: #FDB827; color: #F1F1F1;">Register</button>
                    </div>
                    <div class="text-center text-secondary mt-3">
                        Sudah Punya Akun? <a href="/panel" tabindex="-1">Login</a>
                    </div>
                </div>
            </form>
        </div>
